...
"use strict";function changeNode(e, t) {
	var n = prompt("input content to be shown in selected node");document.getElementsByClassName(e)[t].innerHTML = n;
}function addNodes() {
	var e = document.createElement("li");e.classList.add("introduction__list-item"), e.innerHTML = "I was added using DOM", ilist.appendChild(e), ilist.setAttribute("style", "margin-right:32.5%");var t = document.createElement("input");t.setAttribute("type", "text"), t.setAttribute("placeholder", "i was added using DOM"), t.classList.add("form__text-input"), txtarea.after(t);var n = document.createElement("p");n.setAttribute("class", "footer_text"), n.setAttribute("style", "color:pink"), n.innerHTML = "Some footer text using DOM", document.getElementsByClassName("footer")[0].prepend(n);
}function changeNode(e, t) {
	var n = prompt("input content to be shown in selected node");document.getElementsByClassName(e)[t].innerHTML = n;
}function addNodes() {
	var e = document.createElement("li");e.classList.add("introduction__list-item"), e.innerHTML = "I was added using DOM", ilist.appendChild(e), ilist.setAttribute("style", "margin-right:32.5%");var t = document.createElement("input");t.setAttribute("type", "text"), t.setAttribute("placeholder", "i was added using DOM"), t.classList.add("form__text-input"), txtarea.after(t);var n = document.createElement("p");n.setAttribute("class", "footer_text"), n.setAttribute("style", "color:pink"), n.innerHTML = "Some footer text using DOM", document.getElementsByClassName("footer")[0].prepend(n);
}window.onbeforeunload = function () {
	return "Please Stay :'(";
}, changeNode("highlighted-products__view-text", 1), addNodes(), window.onbeforeunload = function () {
	return "Please Stay :'(";
}, changeNode("highlighted-products__view-text", 1), addNodes();